...
import com.cyb.generation.util.SqlTypeUtil;
...
public class ColumnDefinition  {
	...
	public boolean getIsIgnore() {
		Object ignoreColumns = param.get("ignoreColumns");
		if (ignoreColumns == null) {
			return false;
		}
		String[] arr = StringUtils.split(ignoreColumns.toString(), ',');
		return ArrayUtils.contains(arr, columnName);
	}
